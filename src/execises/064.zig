...
pub fn Ex() void {
    ...
    var overflow = @addWithOverflow(u4, a, b, &my_result);
    ...
    // print("{b:0>4} + {b:0>4} = {b:0>4} ({s})", .{ a, b, my_result, overflow });
    ...
    var expected_result: u4 = undefined;
    overflow = @addWithOverflow(u4, a, b, &expected_result);
    print("{b:0>4} + {b:0>4} = {b:0>4} ({})", .{ a, b, my_result, overflow });
